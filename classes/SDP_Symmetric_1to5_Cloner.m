classdef SDP_Symmetric_1to5_Cloner
    properties
        Omega
    end
    ...
    methods
        % Constructor
        function obj = SDP_Symmetric_1to5_Cloner(states)
            arguments
                states;
            end
        ...
        function [primal__optimum, E] = solvePrimal(obj)
            ...
            cvx_begin sdp quiet
                ...
                subject to
                    ...
                    PartialTrace(E, [2, 3, 4, 5, 6], [2, 2, 2, 2, 2, 2]) == eye(2);
        ...
        function [dual_optimum, Y] = solveDual(obj)
            ...
            cvx_begin sdp quiet
                ...
                variable Z1(64, 64) hermitian 
                variable Z2(64, 64) hermitian 
                variable Z3(64, 64) hermitian 
                variable Z4(64, 64) hermitian 
